...
public class MultipleValueTreeMap implements Map<Short, PageId> {
     ...
     *
     * @param keyObj key whose presence in this map is to be tested
     ...
     */
    public void putAll(Map<? extends Short, ? extends PageId> m) {
        throw new UnsupportedOperationException();
    }
    ...
    public Set<Short> keySet() {
        Set<Short> fullKeySet = new HashSet<Short>();
        for(Short size : mMap.keySet()) {
     ...
     */
    public Set<Map.Entry<Short, PageId>> entrySet() {
        Set<Map.Entry<Short, PageId>> entrySet = new HashSet<Map.Entry<Short, PageId>>();
        for(Short key : keySet()) {
            for(PageId pid : mMap.get(key)) {
    ...
    public static class Entry implements Map.Entry<Short, PageId> {
        Short mShort;
        PageId mPageId;

        public Entry(Short key, PageId value) {
            mShort = key;
            mPageId = value;
        }
        /**
         ...
         *                                       removed from the backing map.
         */
        public PageId setValue(PageId value) {
            PageId old = mPageId;
            mPageId = value;
            return old;
        }
