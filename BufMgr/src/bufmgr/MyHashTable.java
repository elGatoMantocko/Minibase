...
public class MyHashTable implements Map<PageId, Frame>, GlobalConst {
     ...
     * If we have HTSIZE buckets, numbered 0 through M-1,
     * a hash function h of the form h(value) = (a*value+b) mod HTSIZE
     * works well in practice. HTSIZE should be chosen to be a
     * prime number.
     */
    public MyHashTable() {
     ...
     * <tt>true</tt>.)
     *
     * @param pid   key with which the specified value is to be associated
    ...
    public Frame put(PageId pid, Frame value) {
        ...
        directory[bucketid].add(new MyEntry(pid, value));
        return null;
    }
    ...
    public void putAll(Map m) {
        throw new UnsupportedOperationException("putAll() is not supported on this map");
    }
    ...
    static class MyEntry implements Map.Entry<PageId, Frame> {
         ...
         *                                       removed from the backing map.
         */
        public Frame setValue(Frame value) {
            Frame old = mFrame;
            mFrame = value;
            return old;
        }
         ...
         */
        public int hashCode() {
            return this.mFrame.hashCode() & this.mPageId.hashCode();
        }
    }
}
